...
export class BdFinal1716322864324 implements MigrationInterface {
    name = 'BdFinal1716322864324'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bestcompetitions"."competition" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "views" integer NOT NULL DEFAULT '0', "initialDate" TIMESTAMP NOT NULL, "finalDate" TIMESTAMP NOT NULL, "hashtag" character varying NOT NULL, "winner" character varying, "participants" integer NOT NULL DEFAULT '0', "tiktok" character varying NOT NULL, "instagram" character varying NOT NULL, "youtube" character varying NOT NULL, "indActive" boolean NOT NULL DEFAULT true, "id_user" uuid NOT NULL, "dthr_register" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a52a6248db574777b226e9445bc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "bestcompetitions"."dailywin" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "url" character varying NOT NULL, "views" integer NOT NULL DEFAULT '0', "videoDate" TIMESTAMP NOT NULL, "winDate" TIMESTAMP NOT NULL, "diggCount" integer NOT NULL, "username" character varying NOT NULL, "shareCount" integer NOT NULL, "avatarUrl" character varying NOT NULL, "videoUrl" character varying NOT NULL, "nickname" character varying NOT NULL, "id_user" uuid NOT NULL, "id_competition" uuid NOT NULL, "dthr_register" TIMESTAMP NOT NULL DEFAULT now(), "last_update" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_4d7cb4e8a413463ebeff9a62c45" UNIQUE ("url"), CONSTRAINT "PK_581e83ed25ab60e64d1074f7e35" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "bestcompetitions"."dailywin" ADD CONSTRAINT "FK_59244fb9b5d8ffd270d53d3c196" FOREIGN KEY ("id_user") REFERENCES "bestcompetitions"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bestcompetitions"."dailywin" ADD CONSTRAINT "FK_7cab642a724f141ce4227a4a110" FOREIGN KEY ("id_competition") REFERENCES "bestcompetitions"."competition"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bestcompetitions"."dailywin" DROP CONSTRAINT "FK_7cab642a724f141ce4227a4a110"`);
        await queryRunner.query(`ALTER TABLE "bestcompetitions"."dailywin" DROP CONSTRAINT "FK_59244fb9b5d8ffd270d53d3c196"`);
        ...
        await queryRunner.query(`DROP TABLE "bestcompetitions"."dailywin"`);
