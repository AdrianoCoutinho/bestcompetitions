...
export class BdFinal1717806004744 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bestcompetitions"."dailywin" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "winDate" TIMESTAMP NOT NULL, "data" json NOT NULL, "id_competition" uuid NOT NULL, "dthr_register" TIMESTAMP NOT NULL DEFAULT now(), "last_update" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_581e83ed25ab60e64d1074f7e35" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "bestcompetitions"."clip_type_enum" AS ENUM('tiktok', 'instagram', 'youtube')`);
        await queryRunner.query(`CREATE TYPE "bestcompetitions"."clip_status_enum" AS ENUM('Pendente', 'Ativo', 'Cancelado')`);
        await queryRunner.query(`CREATE TABLE "bestcompetitions"."clip" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "url" character varying NOT NULL, "views" integer NOT NULL DEFAULT '0', "videoDate" TIMESTAMP NOT NULL, "diggCount" integer NOT NULL, "username" character varying NOT NULL, "description" character varying NOT NULL, "shareCount" integer NOT NULL, "videoUrl" character varying NOT NULL, "nickname" character varying NOT NULL, "type" "bestcompetitions"."clip_type_enum" NOT NULL, "status" "bestcompetitions"."clip_status_enum" NOT NULL, "id_user" uuid NOT NULL, "id_competition" uuid NOT NULL, "dthr_register" TIMESTAMP NOT NULL DEFAULT now(), "last_update" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fa9732d754b4451431e894b0bb0" UNIQUE ("url"), CONSTRAINT "PK_f0685dac8d4dd056d7255670b75" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "bestcompetitions"."clip_status_enum"`);
        await queryRunner.query(`DROP TYPE "bestcompetitions"."clip_type_enum"`);
