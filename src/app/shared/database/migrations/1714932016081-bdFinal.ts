...
export class BdFinal1714932016081 implements MigrationInterface {
    name = 'BdFinal1714932016081'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bestcompetitions"."competition" ("id" character varying NOT NULL, "name" character varying NOT NULL, "initialDate" TIMESTAMP NOT NULL, "finalDate" TIMESTAMP NOT NULL, "hashtag" character varying NOT NULL, "winner" character varying, "participants" integer NOT NULL DEFAULT '0', "tiktok" character varying, "instagram" character varying, "youtube" character varying, "indActive" boolean NOT NULL DEFAULT true, "dthr_register" TIMESTAMP NOT NULL DEFAULT now(), "userId" character varying, CONSTRAINT "UQ_05207ee7d71c2e2ca971822bed3" UNIQUE ("tiktok"), CONSTRAINT "UQ_65cfc325f97cd61f500714d856d" UNIQUE ("instagram"), CONSTRAINT "UQ_3eefe97032158b80bdeadf97026" UNIQUE ("youtube"), CONSTRAINT "PK_a52a6248db574777b226e9445bc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "bestcompetitions"."competition" ADD CONSTRAINT "FK_03675b35f12dcf83c6c267a0dc3" FOREIGN KEY ("userId") REFERENCES "bestcompetitions"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bestcompetitions"."competition" DROP CONSTRAINT "FK_03675b35f12dcf83c6c267a0dc3"`);
